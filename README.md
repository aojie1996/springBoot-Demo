...
表结构及初始化数据在 <a target="_blank" href="https://code.choerodon.com.cn/hzero-hzero/hzero-resource/tree/1.3.5.RELEASE"><b>hzero-resource</b></a> 项目下。
